...
try:
    ...
    from schemas.messages import Message, LLMResponse, StreamingChunk, ToolCall, Role
except ImportError:
    # Fallback imports for backward compatibility
    try:
        from backend.config import config
        from backend.message_types import Message, LLMResponse, StreamingChunk, ToolCall, Role
    except ImportError:
