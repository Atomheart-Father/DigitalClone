...
try:
    ...
    from schemas.messages import Message, Role, RouteDecision, ConversationContext
    from core.telemetry.logger import ConversationLogger
    from core.kernel.agent_core import AgentCore
    from tools.registry import registry
except ImportError:
    # Fallback imports for backward compatibility
    try:
        from backend.config import config
        from backend.message_types import Message, Role, RouteDecision, ConversationContext
        ...
        from message_types import Message, Role, RouteDecision, ConversationContext
        from logger import ConversationLogger
        from agent_core import AgentCore
        from tool_registry import registry

# Import graph modules if available
try:
    import graph
    ...
    logger.info("Graph modules imported successfully")
...
class CLIApp:
    ...
    def _handle_direct_streaming(self, user_input: str):
        ...
        try:
            streaming_response = self.agent.process_turn(
                ...
                if chunk.tool_calls:
                    ...
                    for tool_call in chunk.tool_calls:
                        ...
                        try:
                            ...
                            follow_up_response = self.agent.process_turn(
    ...
    def _handle_clarification(self, clarification: str):
        ...
        try:
            ...
            from core.kernel.agent_core import RouteDecision

            # Simple heuristic: check if clarification is complex
            route_decision = self.agent.router.route(clarification, None)

            # Continue with clarification
            result = self.agent.continue_with_user_clarification(
                clarification,
    ...
    def _continue_with_parameters(self, parameters: dict, needs_info: dict):
        ...
        try:
            ...
            result = self.agent.continue_with_parameter_input(
                parameters,
                self.conversation_history,
                needs_info
            )
